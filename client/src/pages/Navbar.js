...
<nav className="navbar navbar-expand-lg navbar-light" id="mainNav">
        ...
        <div className="collapse navbar-collapse" id="navbarResponsive">
            <ul className="navbar-nav">
              ...
              <li className="nav-item"><a className="nav-link px-lg-3 py-3 py-lg-4" href="/Courses_Student">Consult Courses</a></li>
              <li className="nav-item"><a className="nav-link px-lg-3 py-3 py-lg-4" href="/main"> Paticipate Class</a></li>
